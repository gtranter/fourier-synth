...
| `autoAdjust`       | `auto-adjust`       | Automatically adjust the gain and DC offset (cos0) to match the wave. This doubles computational effort and therefore impacts performance by ~50%.                                                                                                                                                                                    | `boolean` | `false`                 |
...
| `hideEndpoints`    | `hide-endpoints`    | Don't display the fundamental wave endpoint dots.                                                                                                                                                                                                                                                                                     | `boolean` | `false`                 |
...
| `lineColor`        | `line-color`        | Color of the waveform plot line. Use a CSS color value.                                                                                                                                                                                                                                                                               | `string`  | `this.RED`              |
| `lineWidth`        | `line-width`        | The width of the waveform plot line.                                                                                                                                                                                                                                                                                                  | `number`  | `3`                     |
...
| `offsetColor`      | `offset-color`      | Color of the graph DC offset line and waveform endpoint dots. Use a CSS color value.                                                                                                                                                                                                                                                  | `string`  | `this.GREEN`            |
